...
const FEATURES = [
  ...
  { icon: Camera, title: "ស្កេន និងវាយ", to: "/dictionary", tint: "bg-sky/30", body: "បម្លែងរូបភាពអត្ថបទខ្មែរជាអក្សរ — កំពុងអភិវឌ្ឍ។" },
];
...
const LAYERS = [
  ...
  { n: "៣", title: "ការផ្ទៀងផ្ទាត់ដោយ AI", body: "AI ពិនិត្យវេយ្យាករណ៍ និងរចនាបថ រួចកែសម្រួលបញ្ជីកំហុសឡើងវិញ។" },
];
